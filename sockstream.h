////////////////////////////////////////////////////////////////////////////////
// $Id: sockstream.h 5280 2016-03-14 18:49:29Z mellinger $
...
class fd_object
{
 public:
  ...
  {
    infinite_timeout = -1,
    default_timeout = 1000000, // ms, was initially 5000
  };
...
class streambuf : public std::streambuf
{
  ...
  protected:
    ...
    virtual std::streampos on_seek_to( std::streampos  ) { return -1; }
...
{
  static const size_t s_bufsize = 262144; // was initially 1024
  public:
    fd_streambuf( fd_object& f )
    : streambuf( &mp_getbuf, &m_bufsize, &mp_putbuf, &m_bufsize ),
      mp_getbuf( m_getbuf ), mp_putbuf( m_putbuf ), m_bufsize( s_bufsize ),
      m_fd( &f ) {}
    ~fd_streambuf() { sync(); }
    const fd_object& fd_object() { return *m_fd; }
  protected:
